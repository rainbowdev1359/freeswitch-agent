...
import LicenseMinutePrices from "../component/superadmin/licenseMinutePrices";
import { useSelector } from "react-redux";
import { RootState } from "../store";
import Toggle from "../component/Toggle";
import { H1Styled, DivStyled, PModified, PageContainer } from "../component/StyleComponents";

export function LicenseMinutePricesPage({ isSidebarOpened }: { isSidebarOpened: boolean }) {
