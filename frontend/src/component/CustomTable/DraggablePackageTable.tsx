...
function DraggablePackageTable({
  backgroundColor,
  headerColor,
  radius,
  columns,
            ...
            <Td>
              ...
              <td>
                <div className="d-flex align-items-center justify-content-center">
                  <DateButton textcolor='#000000' color='#A1D9FC' onClick={() => onChoose("starter")}>{chooseTitle ?? "Choose"}</DateButton>
                </div>
              </td>
              <td>
                <div className="d-flex align-items-center justify-content-center">
                  <DateButton textcolor='#FAFAFA' color='#4094D2' onClick={() => onChoose("professional")}>{chooseTitle ?? "Choose"}</DateButton>
                </div>
              </td>
              <td>
                <div className="d-flex align-items-center justify-content-center">
                  <DateButton textcolor='#FAFAFA' color='#0673DC' onClick={() => onChoose("enterprise")}>{chooseTitle ?? "Choose"}</DateButton>
                </div>
              </td>
              <td>
                <div className="d-flex align-items-center justify-content-center">
                  <DateButton textcolor='#FAFAFA' color='#0E39D3' onClick={() => onChoose("ultimate")}>{chooseTitle ?? "Choose"}</DateButton>
                </div>
              </td>
            </Td>
          </tbody>
...
export default DraggablePackageTable;
